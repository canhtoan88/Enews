...
-- View: Total articles follow category for adminitrator
...
-- Trigger: for Insert Admin account
...
-- Select User from id
DELIMITER //
CREATE PROCEDURE FIND_USER_BY_ID_PROC
(IN id char(10))
BEGIN
...
CREATE USER 'canhtoan88'@'localhost' IDENTIFIED BY 'Canhtoan88';
